...
# 原始数据集
original_path = '/home/xby00008312/llm_cptt/glm_finetune/from_github/ChatGLM3/finetune_demo/data/spider_test_original/dev.json'
with open(original_path,'r') as f:
    data = json.load(f)

# 只有question和query的数据集
train_path = '/home/xby00008312/llm_cptt/glm_finetune/from_github/ChatGLM3/finetune_demo/data/spider_test/dev.json'
